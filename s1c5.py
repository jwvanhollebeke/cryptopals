...
INPUT = bytearray('''Burning 'em, if you ain't quick and nimble
I go crazy when I hear a cymbal'''.encode('utf-8'))
EXPECTED = '0b3637272a2b2e63622c2e69692a23693a2a3c6324202d623d63343c2a26226324272765272a282b2f20430a652e2c652a3124333a653e2b2027630c692b20283165286326302e27282f'

def repeating_key_xor(content, key):
    key_cycle = cycle(bytes(key, 'ascii'))
    result = bytes([byte ^ next(key_cycle) for byte in content])
    return result

if __name__ == "__main__":
    print('Set 1: Challenge 5: Vanilla Ice')
    encoded = repeating_key_xor(INPUT, 'ICE')
    print(encoded.hex() == EXPECTED)
